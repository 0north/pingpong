...
docker build -t 407087036459.dkr.ecr.eu-west-1.amazonaws.com/pingpong:latest --platform linux/amd64 .
docker push 407087036459.dkr.ecr.eu-west-1.amazonaws.com/pingpong:latest
```
